...
class Api::V1::PostsControllerTest < ActionDispatch::IntegrationTest
  test 'access of posts in Interest' do
    app = Doorkeeper::Application.first_or_create(name: 'Web', redirect_uri: '', scopes: '')

    Interest.first_or_create(
      name: 'Campfire General Interest',
      creator_id: 1,
      public: 1
    )

    get '/api/v1/posts', params: { context_type: 'Interest', context_id: 1 }
    ...
    get '/api/v1/posts',
        params: { context_type: 'Interest', context_id: 1 },
